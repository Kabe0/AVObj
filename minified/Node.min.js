namespace(AV.Utilities,function(){this.Page={};this.Node={};this.node={};this.text={};this.P={}});
...
P=function(a,b){return Page.find.apply(a,arguments)};empty=function(){return Page.empty.apply(Page,arguments)}});
