...
var AVObj={init:function(){},deInit:function(){},extend:function(a){var b={parent:{get:function(){return Object.getPrototypeOf(this)},enumerable:!1,configurable:!1},super:{value:function(){return Object.getPrototypeOf(this).init.apply(this,arguments)},writable:!1,configurable:!1},_observers:{value:{},writable:!0,configurable:!1,enumerable:!1}},c=!1;a&&(a.generateSingleton&&(b.create={value:function(){console.error("Please use singleton constructor 'instance' instead.");return null},writable:!1,configrable:!1},
b._instance={value:null,writable:!0,configrable:!1},b.instance={get:function(){null==this._instance&&(this._instance=this.createFinal(),this.init.apply(this._instance,arguments));return d._instance}}),a.initOnPageLoad&&(c=!0),a.initStaticObject&&(b.create={value:function(){console.error("Cannot create a static object!");return null},writable:!1,configrable:!1},b.destroy={value:function(){console.error("Cannot destroy a static object!")},writable:!1,configrable:!1}),a.preventExtension&&(b._lockExtensions=
{value:!0,writable:!1,configrable:!1,enumerable:!1}));var d=Object.create(this,b);c&&AVObj._AVLoadList.push(d);return d},createFinal:function(){return Object.create(this,{parent:{get:function(){console.error("Cannot get from keyword 'this.parent'. Please avoid any parent calls that could be scoped to other objects!");return null},enumerable:!1,configurable:!1},super:{value:function(){console.error("Cannot call super(); with 'this.super'. please avoid any super calls that could be scoped to other objects!");
return null},writable:!1,configurable:!1},_observers:{value:{},writable:!0,configurable:!1,enumerable:!1},_isDestroyed:{value:!1,writable:!0,configurable:!1,enumerable:!1},create:{value:function(){console.error("You can't call create on an object that has already been built!");return null},writable:!1,configurable:!1,enumerable:!1},destroyed:{value:function(){return this._isDestroyed},writable:!0,configurable:!1,enumerable:!1},destroy:{value:function(){this._isDestroyed||(this.clearObservers(),this.deInit(),
