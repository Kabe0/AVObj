Function.prototype.bind||(Function.prototype.bind=function(a){if("function"!==typeof this)throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");var b=Array.prototype.slice.call(arguments,1),c=this,d=function(){},e=function(){return c.apply(this instanceof d?this:a||window,b.concat(Array.prototype.slice.call(arguments)))};d.prototype=this.prototype;e.prototype=new d;return e});var AVObj=null,AVObjMacro=function(a,b){};
Object.prototype.watch||Object.defineProperty(Object.prototype,"watch",{enumerable:!1,configurable:!0,writable:!1,value:function(a,b){var c=this[a],d=c,e=function(){return d},k=function(e){c=d;return d=b.call(this,a,c,e)};delete this[a]&&Object.defineProperty(this,a,{get:e,set:k,enumerable:!0,configurable:!0})}});Object.prototype.unwatch||Object.defineProperty(Object.prototype,"unwatch",{enumerable:!1,configurable:!0,writable:!1,value:function(a){var b=this[a];delete this[a];this[a]=b}});
function namespace(a,b){var c=window;a=a.split(".");for(var d=0;d<a.length;d++)a[d]in c||(c[a[d]]={}),c=c[a[d]];null!=b&&b.apply(c);return c}
function usingNamespace(){for(var a=[],b=[],c=[],d=[],e=0;e<arguments.length-1;e++){for(var k=arguments[e].split("."),f=window[k[0]],h=1;h<k.length;h++)f=f[k[h]];for(var g in f)if("object"===typeof f[g]||"function"===typeof f[g])a.push(f),b.push(f[g]),c.push(g),d.push(f)}e=/^function\s*\(([\s\w\d,]*)\s*\)\s*\{([\S\s]*)}$/g.exec(arguments[arguments.length-1].toString())[2];e+="return ["+c.toString()+"];";b=Function(c,e).apply(window,b);for(e=0;e<b.length;e++)d[e][c[e]]=b[e]}
...
(a._instance=a.createFinal(),a._instance.init()):console.warn("Object "+a+" has already been created.")})})})();namespace("AVObj.Utilities",function(){this.empty=this.P=this.text=this.node=this.Node=this.Page=null;this.cakeStuff=!0});
...
a,d)},this.element.addEventListener(a,d.function,!1));this.addObserver(a,b,c)},removeNObserver:function(a,b,c){this.removeObserver(a,b,c);this.getNumObservers(a)||(this.element.removeEventListener(a,this.bindedEvents[b].function,!1),delete this.bindedEvents[b])},removeNObservers:function(a){this.removeObservers(a);for(var b in this.bindedEvents)this.bindedEvents[b].eventName==a&&this.element.removeEventListener(a,this.bindedEvents[b].function,!1);delete this.bindedEvents},clearNObservers:function(){for(var a in this.bindedEvents){var b=
this.bindedEvents[a];this.removeObservers(b.eventName);this.element.removeEventListener(b.eventName,b.function)}},fireEvent:function(a,b,c){this.fireObservers(a,c,b)}});node=function(a,b){cakeStuff=!1;return Page.build.apply(Page,arguments)};text=function(a){return Page.text.apply(Page,arguments)};P=function(a,b){return Page.find.apply(a,arguments)};empty=function(){return Page.empty.apply(Page,arguments)}});var CheckMedia=AVObj.extend({generateSingleton:!0});
