...
function namespace(a,b){var c=window;switch(typeof a){case "object":c=a;break;case "string":a=a.split(".");for(var d=0,e=a.length;d<e;d++)a[d]in c||(c[a[d]]={}),c=c[a[d]]}null!=b&&b.apply(c);return c}
function usingNamespace(a){var b=[],c=[],d=[],e,m=arguments.length-1;for(e=0;e<m;e++){switch(typeof arguments[e]){case "object":g=arguments[e];break;case "string":for(var f=arguments[e].split("."),g=window[f[0]],h=1,l=f.length;h<l;h++)g=g[f[h]]}for(var k in g)if("object"===typeof g[k]||"function"===typeof g[k])d.push(g),b.push(k),c.push(g[k])}e=/^function\s*\([\s\w\d,]*\s*\)\s*\{([\S\s]*)}$/g.exec(arguments[m].toString())[1]+" return ["+b.toString()+"];";c=Function(b,e).apply(this,c);for(e=c.length;e--;)d[e][b[e]]=
c[e]}var AVObj=null,AV={Utilities:{},AVApp:{}},AVObjMacro=function(a,b){};
...
configurable:!1,enumerable:!1},destroyed:{value:function(){return b},writable:!0,configurable:!1,enumerable:!1},destroy:{value:function(){b||(this.clearObservers(),this.deInit(),b=!0,Object.seal(this))},writable:!1,configurable:!1}})}var b={},c={value:{},writable:!0,configurable:!1,enumerable:!1},d={value:function(){var e=a(this);e.init.apply(e,arguments);return e},writable:!1,configurable:!1};AVObjMacro=function(a,c,d){null==b[a]?b[a]={before:c,after:d}:console.error(a+" Macro is already defined!")};
...
1,arguments.length),d=this._observers[a][b];d.function.apply(d.scope,c)}},addObserver:function(a,b,c){c||(c=window);this._observers[a]||(this._observers[a]=[]);c[b]?this._observers[a].push({scope:c,functionName:b,function:c[b]}):console.error(b+" Does not exist in the given scope of ",c)},addAObserver:function(a,b,c,d){d||(d=window);this._observers[a]||(this._observers[a]=[]);this._observers[a].push({scope:d,functionName:b,function:c})},getNumObservers:function(a){return this._observers[a]?this._observers[a].length:
0},removeObserver:function(a,b,c){for(var d=this._observers[a],h=0;h<d.length;h++)if(d[h].scope==c&&d[h].functionName==b){this._observers[a].splice(h,1);break}0==d.length&&delete this._observers[a]},removeObservers:function(a){delete this._observers[a]},clearObservers:function(){this._observers={}}};Object.defineProperties(AVObj,{_observers:{value:{},writable:!0,configurable:!1,enumerable:!1},_extensionCount:{value:0,writable:!1,configurable:!1,enumerable:!1},_AVLoadList:{value:[],writable:!1,configurable:!1,
enumerable:!1},parent:{value:AVObj},create:d});window.addEventListener("load",function(){AVObj._AVLoadList.forEach(function(a){null==a._instance?(a._instance=a.createFinal(),a._instance.init()):console.warn("Object "+a+" has already been created.")})})})();namespace(AV.Utilities,function(){this.Page=AVObj.extend({initStaticObject:!0,preventExtensions:!0});this.Node=AVObj.extend({preventExtensions:!1});this.node={};this.text={};this.P={}});
usingNamespace(AV.Utilities,function(){Page.properties={find:function(a,b){b=null==b?document:b;var c;if(null!=a&&0<a.length)switch(a.charAt(0)){case ".":c=b.getElementsByClassName(a.slice(1,a.length));break;case "#":c=b.getElementById(a.slice(1,a.length));break;default:null!=a&&0<a.length&&(c=b.getElementsByTagName(a))}if(c)return Page.generateNodeFromElements(c);console.error("Node/nodes do not exist by that name!")},generateNodeFromElements:function(a){if(a.length){for(var b=[],c=0;c<a.length;c++)b.push(a[c]._nodeDat?
a[c]._nodeDat:Node.create(a[c]));return b}return a._nodeDat?a._nodeDat:Node.create(a)},build:function(a,b){var c=document.createElement(a),d;for(d in b)switch(d){case "text":c.appendChild(text(b[d]));break;case "htmlText":c.innerHTML=b[d];break;default:c.setAttribute(d,b[d])}return Node.create(c)},empty:function(){for(var a=arguments.length;a--;)if(!arguments[a]||0===arguments[a].length)return!0;return!1},text:function(a){return document.createTextNode(a)}};Node.properties={events:{value:{CLICK:"click",
...
this.data[b])}else a=this.data;else a=this.convertToString();"string"==typeof a&&this.request.setRequestHeader("Content-type","application/x-www-form-urlencoded");return a}})});namespace("AV.Utilities",function(){AVObj.extend().prop={play:function(a,b,c){},pause:function(){}}});
