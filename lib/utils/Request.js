/**
 * Created by Ian Carson on 3/3/2014.
...
var Request = AVObj.extend({generateSingleton : true});
Request.properties =
{
	...
	/**
	 * Call Request Init to create a request for a specific page. This function has been overrided for visibility purposes only.
	 *
	 ...
	 */
	create : function(method, url, asynchronous, finishFunction, data)
	{
		return Request.parent.create.apply(this, arguments);
	},
