...
/**
 * @class
 * @classdesc The Page Class handles node creation and management.
 *
 * @extends AVObj
 */
...
Page.properties =
{
	...
	/**
	 * Generates <code>Node</code> objects from elements passed in by the parameter nodeObjects.
	 * @param {element|element[]} nodeObjects The objects that need to be encased (if not already) in a Node object.
 ...
 * @returns {Node}
 */
function node(nodeName, nodeProperties)
{
