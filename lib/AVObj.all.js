 ...
 *
 * This is a complete package of all the AVObj utils included as one single file.
 */
"use strict";
...
Node.properties =
{
	...
	addNObserver: function ( eventName, functionName, scope, data )
	{
		...
		{
			this.element.addEventListener( eventName, this.bindedEvents[functionName] = this.fireEvent.bind( this, eventName, data ), false );
		}
