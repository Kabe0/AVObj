...
var AVObj =
{
	...
	removeObserver: function ( eventName, functionName, scope )
	{
		...
		if ( i >= 0 )
		{
			this._observers[eventName].scope = this._observers[eventName].scope.splice( i, 1 );
			this._observers[eventName].original = this._observers[eventName].original.splice( i, 1 );
		}
	},
