...
(function ()
{
	...
	AVObj =
	{
		 ...
		 * @param macros You can set function macro's such as
		 * <ul>
		...
		extend: function ( macros )
		{
			...
			if ( macros )
			{		// Only bother if the user asked for the macro's
		...
		set properties( objs )
		{
			...
			for ( var obj in objs )
			{
				if ( typeof objs[obj] == 'object' && objs[obj] != null )
				{
					...
					if ( typeof objs[obj].get == "function" || typeof objs[obj].set == "function" || typeof objs[obj].value )
					{
