	...
	createFinal: function ()
	{
		var newObjectValues =
		{
			...
			callParent :
			{
				 ...
				 * @param parents Specify the parent you want to call (1) is the minimum required (if no value, (1) is assumed).
				 * @param arguments other arguments related to the method being called.
				 * @returns {*} returns whatever the method called returns.
				 */
				value : function( methodName, parents )
				{
					this._methodTrack+= ( parents != null && parents > 0 ? parents : 1 );

					var returnValue = this["_parent" + ( this._extensionCount - ( this._methodTrack - 1) )][methodName].apply(this, arguments);
					this._methodTrack = 0;
